...
import "./Proof.sol";
import "./MaritimeMarketStructs.sol";
...
contract MaritimeDataMarketCore is MaritimeMarketStructs {
    ...
    constructor(address _feeToSetter, string memory _systemId){
    ...
    function revokeMaritimeOrder(bytes32 orderHash) internal {
    ...
    function matchMaritimeOrders(bytes memory hashOrders,bytes memory singers, bytes memory callDatas,bytes memory callTarget, bytes memory signatures,bytes memory orderData)  internal{
