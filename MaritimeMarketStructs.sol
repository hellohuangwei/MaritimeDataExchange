...
contract MaritimeMarketStructs {
    ...
    struct Order {
        ...
        string vesselId;       // Ship's Unique Identification Code
        string region;         // Data's affiliated sea area
        string dataCategory;   //Data type (e.g., AIS, meteorological, radar, etc.)
        string dataUri;        //Metadata of maritime data 
    }
